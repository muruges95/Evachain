...
export default class ListScreen extends React.Component {
	...
	render() {
		if (this.props.user === undefined) {
			...
			return null;
		} else if (this.props.user === "fireman"){
			return <FiremanView data={this.props.homes} />
		} else {
			return <CivilianView data={this.props.shelters} />
		}
	}
}
